import { getCursorPos as e, everyTick as t, clearTimeout as _, setTimeout as i, logError as n, emit as a, getGxtText as s, showCursor as o, setInterval as r, clearInterval as l, logWarning as c, onServer as m, Player as h, emitServer as p, hash as d, RGBA as u, Vehicle as g, Entity as w, on as f } from "alt-client";
import y, {
  ...
  getFilenameForAudioConversation as Ke,
...
!(function (e) {
  (e[(e.NextCamera = 0)] = "NextCamera"),
    ...
    (e[(e.VehicleSpecialAbilityFranklin = 93)] = "VehicleSpecialAbilityFranklin"),
    ...
    (e[(e.VehicleFlyVerticalFlightMode = 119)] = "VehicleFlyVerticalFlightMode"),
    (e[(e.VehicleFlyDuck = 120)] = "VehicleFlyDuck"),
    (e[(e.VehicleFlyAttackCamera = 121)] = "VehicleFlyAttackCamera"),
    (e[(e.VehicleFlyMouseControlOverride = 122)] = "VehicleFlyMouseControlOverride"),
    ...
    (e[(e.VehicleSubMouseControlOverride = 135)] = "VehicleSubMouseControlOverride"),
    ...
    (e[(e.ReplayStartStopRecordingSecondary = 289)] = "ReplayStartStopRecordingSecondary"),
...
!(function (e) {
  (e[(e.HUD_COLOUR_PURE_WHITE = 0)] = "HUD_COLOUR_PURE_WHITE"),
    ...
    (e[(e.HUD_COLOUR_SIMPLEBLIP_DEFAULT = 60)] = "HUD_COLOUR_SIMPLEBLIP_DEFAULT"),
    (e[(e.HUD_COLOUR_MENU_BLUE = 61)] = "HUD_COLOUR_MENU_BLUE"),
    (e[(e.HUD_COLOUR_MENU_GREY_LIGHT = 62)] = "HUD_COLOUR_MENU_GREY_LIGHT"),
    (e[(e.HUD_COLOUR_MENU_BLUE_EXTRA_DARK = 63)] = "HUD_COLOUR_MENU_BLUE_EXTRA_DARK"),
    ...
    (e[(e.HUD_COLOUR_NET_PLAYER26_DARK = 100)] = "HUD_COLOUR_NET_PLAYER26_DARK"),
    (e[(e.HUD_COLOUR_NET_PLAYER27_DARK = 101)] = "HUD_COLOUR_NET_PLAYER27_DARK"),
    (e[(e.HUD_COLOUR_NET_PLAYER28_DARK = 102)] = "HUD_COLOUR_NET_PLAYER28_DARK"),
    (e[(e.HUD_COLOUR_NET_PLAYER29_DARK = 103)] = "HUD_COLOUR_NET_PLAYER29_DARK"),
    (e[(e.HUD_COLOUR_NET_PLAYER30_DARK = 104)] = "HUD_COLOUR_NET_PLAYER30_DARK"),
    (e[(e.HUD_COLOUR_NET_PLAYER31_DARK = 105)] = "HUD_COLOUR_NET_PLAYER31_DARK"),
    (e[(e.HUD_COLOUR_NET_PLAYER32_DARK = 106)] = "HUD_COLOUR_NET_PLAYER32_DARK"),
    ...
    (e[(e.HUD_COLOUR_PAUSE_SINGLEPLAYER = 122)] = "HUD_COLOUR_PAUSE_SINGLEPLAYER"),
    ...
    (e[(e.HUD_COLOUR_PM_MITEM_HIGHLIGHT = 127)] = "HUD_COLOUR_PM_MITEM_HIGHLIGHT"),
    ...
    (e[(e.HUD_COLOUR_PM_WEAPONS_PURCHASABLE = 159)] = "HUD_COLOUR_PM_WEAPONS_PURCHASABLE"),
    (e[(e.HUD_COLOUR_PM_WEAPONS_LOCKED = 160)] = "HUD_COLOUR_PM_WEAPONS_LOCKED"),
    (e[(e.HUD_COLOUR_END_SCREEN_BG = 161)] = "HUD_COLOUR_END_SCREEN_BG"),
    (e[(e.HUD_COLOUR_CHOP = 162)] = "HUD_COLOUR_CHOP"),
    (e[(e.HUD_COLOUR_PAUSEMAP_TINT_HALF = 163)] = "HUD_COLOUR_PAUSEMAP_TINT_HALF"),
    (e[(e.HUD_COLOUR_NORTH_BLUE_OFFICIAL = 164)] = "HUD_COLOUR_NORTH_BLUE_OFFICIAL"),
    (e[(e.HUD_COLOUR_SCRIPT_VARIABLE_2 = 165)] = "HUD_COLOUR_SCRIPT_VARIABLE_2"),
    ...
    (e[(e.HUD_COLOUR_CONTROLLER_MICHAEL = 171)] = "HUD_COLOUR_CONTROLLER_MICHAEL"),
    ...
    (e[(e.HUD_COLOUR_VIDEO_EDITOR_AUDIO = 176)] = "HUD_COLOUR_VIDEO_EDITOR_AUDIO"),
    (e[(e.HUD_COLOUR_VIDEO_EDITOR_TEXT = 177)] = "HUD_COLOUR_VIDEO_EDITOR_TEXT"),
...
(Rt.Empty = new Rt(0, 0, 0, 0)), (Rt.Transparent = new Rt(0, 0, 0, 0)), (Rt.Black = new Rt(0, 0, 0, 255)), (Rt.White = new Rt(255, 255, 255, 255)), (Rt.WhiteSmoke = new Rt(245, 245, 245, 255));
class Ot {
  constructor(e = 0, t = 0) {
...
class bt extends St {
  constructor(e, t, _, i, n, a) {
    super(), (this.Caption = e), (this.Pos = t), (this.Scale = _), (this.Color = i || new Rt(255, 255, 255, 255)), (this.Font = n || 0), (this.Centered = a || !1);
  }
  Draw(e, t, _, i, n, a) {
    !e || t || _ || i || n || a || ((t = new Mt(this.Pos.X + e.Width, this.Pos.Y + e.Height)), (_ = this.Scale), (i = this.Color), (n = this.Font), (a = this.Centered));
    const s = t.X / 1280,
      o = t.Y / 720;
    y.setTextFont(parseInt(n)), y.setTextScale(_, _), y.setTextColour(i.R, i.G, i.B, i.A), y.setTextCentre(a), y.beginTextCommandDisplayText("STRING"), bt.AddLongString(e), y.endTextCommandDisplayText(s, o, 0);
  }
    ...
    if (e.length)
      for (let t, _ = 0; _ < e.length; _ += 99) {
        let i = e.substr(_, _ + 99),
          n = _;
        (i.match(/~/g) || []).length % 2 != 0 ? ((t = i.lastIndexOf("~")), (_ -= 99 - t)) : (t = Math.min(99, e.length - n)), y.addTextComponentSubstringPlayerName(e.substr(n, t));
      }
  }
}
const Ct = y.getActualScreenResolution(0, 0);
class kt {
  ...
  static IsMouseInBounds(e, t) {
    ...
    return _.X >= e.X && _.X <= e.X + t.Width && _.Y > e.Y && _.Y < e.Y + t.Height;
  }
  static GetTextWidth(e, t, _) {
    y.beginTextCommandGetScreenWidthOfDisplayText("CELL_EMAIL_BCON"), bt.AddLongString(e), y.setTextFont(t), y.setTextScale(1, _);
    const i = y.endTextCommandGetScreenWidthOfDisplayText(!0);
    return kt.ResolutionMaintainRatio.Width * i;
  }
  static GetLineCount(e, t, _, i, n) {
    y.beginTextCommandGetNumberOfLinesForString("CELL_EMAIL_BCON"), bt.AddLongString(e);
    ...
    return y.endTextCommandGetNumberOfLinesForString(s, o);
  }
}
(kt.Width = Ct[1]), (kt.Height = Ct[2]);
class Lt {
  constructor(e, t, _, i, n = 0, a = new Rt(255, 255, 255)) {
    (this.TextureDict = e), (this.TextureName = t), (this.Pos = _), (this.Size = i), (this.Heading = n), (this.Color = a), (this.Visible = !0);
  }
  ...
  Draw(e, t, _, i, n, a, s) {
    (e = e || this.TextureDict), (t = t || this.TextureName), (_ = _ || this.Pos), (i = i || this.Size), (n = n || this.Heading), (a = a || this.Color), (s = s || !0) && (y.hasStreamedTextureDictLoaded(e) || y.requestStreamedTextureDict(e, !0));
    const o = (kt.Width / kt.Height) * 1080,
      r = this.Size.Width / o,
      l = this.Size.Height / 1080,
      c = this.Pos.X / o + 0.5 * r,
      m = this.Pos.Y / 1080 + 0.5 * l;
      y.drawSprite(e, t, c, m, r, l, n, a.R, a.G, a.B, a.A, false, 2);
  }
}
class Dt extends St {
  constructor(e, t, _) {
    super(), (this.Enabled = !0), (this.Pos = e), (this.Size = t), (this.Color = _);
  }
  Draw(e, t, _) {
    e || (e = new Ot(0, 0)), t || _ || ((e = new Mt(this.Pos.X + e.Width, this.Pos.Y + e.Height)), (t = this.Size), (_ = this.Color));
...
class It extends Dt {
  ...
  Draw(e, t, _) {
    e || (e = new Ot()), !e || t || _ || ((e = new Mt(this.Pos.X + e.Width, this.Pos.Y + e.Height)), (t = this.Size), (_ = this.Color));
...
class Tt extends bt {
  constructor(e, t, _, i, n, a) {
    super(e, t, _, i || new Rt(255, 255, 255), n || 0, !1), (this.TextAlignment = ut.Left), (this.Wrap = 0), a && (this.TextAlignment = a);
  }
  get WordWrap() {
  ...
  Draw(e, t, _, i, n, a, s, o, r) {
    let l = e,
      m = a,
      h = a;
    e || (e = new Ot(0, 0)), e && !t && ((h = this.TextAlignment), (l = this.Caption), (t = new Mt(this.Pos.X + e.Width, this.Pos.Y + e.Height)), (_ = this.Scale), (i = this.Color), (n = this.Font), 1 == m || 0 == m ? (m = this.Centered) : ((m = void 0), (s = this.DropShadow), (o = this.Outline), this.WordWrap));
    const p = (kt.Width / kt.Height) * 1080,
      d = this.Pos.X / p,
      u = this.Pos.Y / 1080;
    if ((y.setTextFont(parseInt(n)), y.setTextScale(1, _), y.setTextColour(i.R, i.G, i.B, i.A), void 0 !== m)) y.setTextCentre(m);
    else {
      switch ((s && y.setTextDropshadow(2, 0, 0, 0, 0), o && c("[NativeUI] ResText outline not working!"), h)) {
        case ut.Centered:
          y.setTextCentre(!0);
          break;
        case ut.Right:
    ...
    y.beginTextCommandDisplayText("CELL_EMAIL_BCON"), bt.AddLongString(l), y.endTextCommandDisplayText(d, u, 0);
  }
}
function Pt() {
  let e,
...
class At {
  constructor(e, t = "", _ = null) {
    (this.Id = Pt()),
      ...
      (this.Enabled = !0),
      (this.Data = _),
      (this._rectangle = new It(new Mt(0, 0), new Ot(431, 38), new Rt(150, 0, 0, 0))),
      (this._text = new Tt(e, new Mt(8, 0), 0.33, Rt.WhiteSmoke, pt.ChaletLondon, ut.Left)),
      (this.Description = t),
      (this._selectedSprite = new Lt("commonmenu", "gradient_nav", new Mt(0, 0), new Ot(431, 38))),
      (this._badgeLeft = new Lt("commonmenu", "", new Mt(0, 0), new Ot(40, 40))),
      (this._badgeRight = new Lt("commonmenu", "", new Mt(0, 0), new Ot(40, 40))),
  ...
  set Description(e) {
    (this._description = e), this.hasOwnProperty("Parent") && this.Parent.UpdateDescriptionCaption();
  }
  SetVerticalPosition(e) {
    (this._rectangle.Pos = new Mt(this.Offset.X, e + 144 + this.Offset.Y)), (this._selectedSprite.Pos = new Mt(0 + this.Offset.X, e + 144 + this.Offset.Y)), (this._text.Pos = new Mt(8 + this.Offset.X, e + 147 + this.Offset.Y)), (this._badgeLeft.Pos = new Mt(0 + this.Offset.X, e + 142 + this.Offset.Y)), (this._badgeRight.Pos = new Mt(385 + this.Offset.X, e + 142 + this.Offset.Y)), (this._labelText.Pos = new Mt(420 + this.Offset.X, e + 148 + this.Offset.Y));
  }
  addEvent(e, ...t) {
  ...
  Draw() {
    (this._rectangle.Size = new Ot(431 + this.Parent.WidthOffset, 38)),
      ...
      this.Hovered && !this.Selected && ((this._rectangle.Color = new Rt(255, 255, 255, 20)), this._rectangle.Draw()),
      (this._selectedSprite.Color = this.Selected ? this.HighlightedBackColor : this.BackColor),
      this._selectedSprite.Draw(),
      (this._text.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      this.LeftBadge != mt.None ? ((this._text.Pos = new Mt(35 + this.Offset.X, this._text.Pos.Y)), (this._badgeLeft.TextureDict = this.BadgeToSpriteLib(this.LeftBadge)), (this._badgeLeft.TextureName = this.BadgeToSpriteName(this.LeftBadge, this.Selected)), (this._badgeLeft.Color = this.IsBagdeWhiteSprite(this.LeftBadge) ? (this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)) : Rt.White), this._badgeLeft.Draw()) : (this._text.Pos = new Mt(8 + this.Offset.X, this._text.Pos.Y)),
      this.RightBadge != mt.None && ((this._badgeRight.Pos = new Mt(385 + this.Offset.X + this.Parent.WidthOffset, this._badgeRight.Pos.Y)), (this._badgeRight.TextureDict = this.BadgeToSpriteLib(this.RightBadge)), (this._badgeRight.TextureName = this.BadgeToSpriteName(this.RightBadge, this.Selected)), (this._badgeRight.Color = this.IsBagdeWhiteSprite(this.RightBadge) ? (this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)) : Rt.White), this._badgeRight.Draw()),
      this.RightLabel && "" !== this.RightLabel && ((this._labelText.Pos = new Mt(420 + this.Offset.X + this.Parent.WidthOffset, this._labelText.Pos.Y)), (this._labelText.Caption = this.RightLabel), (this._labelText.Color = this._text.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)), this._labelText.Draw()),
      this._text.Draw();
  }
  SetLeftBadge(e) {
    this.LeftBadge = e;
...
(At.DefaultBackColor = Rt.Empty), (At.DefaultHighlightedBackColor = Rt.White), (At.DefaultForeColor = Rt.WhiteSmoke), (At.DefaultHighlightedForeColor = Rt.Black);
class Ut extends At {
  constructor(e, t = !1, _ = "") {
    super(e, _), (this.Checked = !1), (this._checkedSprite = new Lt("commonmenu", "shop_box_blank", new Mt(410, 95), new Ot(50, 50))), (this.Checked = t);
  }
  SetVerticalPosition(e) {
    super.SetVerticalPosition(e), (this._checkedSprite.Pos = new Mt(380 + this.Offset.X + this.Parent.WidthOffset, e + 138 + this.Offset.Y));
  }
  Draw() {
    super.Draw(), (this._checkedSprite.Pos = this._checkedSprite.Pos = new Mt(380 + this.Offset.X + this.Parent.WidthOffset, this._checkedSprite.Pos.Y));
    const e = this.HighlightedForeColor == At.DefaultHighlightedForeColor;
    this.Selected && e ? (this._checkedSprite.TextureName = this.Checked ? "shop_box_tickb" : "shop_box_blankb") : (this._checkedSprite.TextureName = this.Checked ? "shop_box_tick" : "shop_box_blank"), (this._checkedSprite.Color = this.Enabled ? (this.Selected && !e ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)), this._checkedSprite.Draw();
  }
  SetRightBadge(e) {
    return this;
  }
...
class vt {
  ...
  getListItems() {
    const e = [];
    for (const t of this.items) t instanceof Et ? e.push(t) : "string" == typeof t ? e.push(new Et(t)) : "number" == typeof t && e.push(new Et(t.toString()));
    return e;
  }
}
class Ht extends At {
  constructor(e, t = "", _ = new vt([]), i = 0, n = null) {
    super(e, t, n), (this.ScrollingEnabled = !0), (this.HoldTimeBeforeScroll = 200), (this._currentOffset = 0), (this._itemsCollection = []), (this._index = 0), (this.Collection = _.getListItems()), (this.Index = i), (this._arrowLeft = new Lt("commonmenu", "arrowleft", new Mt(110, 105), new Ot(30, 30))), (this._arrowRight = new Lt("commonmenu", "arrowright", new Mt(280, 105), new Ot(30, 30))), (this._itemText = new Tt("", new Mt(290, 104), 0.35, Rt.White, pt.ChaletLondon, ut.Right));
  }
  get Collection() {
  ...
  get Index() {
    return null == this.Collection || (null != this.Collection && 0 == this.Collection.length) ? -1 : this._index % this.Collection.length;
  }
  set Index(e) {
    ...
    this._currentOffset = kt.GetTextWidth(t, this._itemText && this._itemText.Font ? this._itemText.Font : 0, 0.35);
  }
  setCollection(e) {
  ...
  setCollectionItem(e, t, _ = !0) {
    ...
    "string" == typeof t && (t = new Et(t)), this.Collection.splice(e, 1, t), _ && (this.Index = 0);
  }
  SetVerticalPosition(e) {
    (this._arrowLeft.Pos = new Mt(300 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)), (this._arrowRight.Pos = new Mt(400 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)), (this._itemText.Pos = new Mt(300 + this.Offset.X + this.Parent.WidthOffset, e + 147 + this.Offset.Y)), super.SetVerticalPosition(e);
  }
  SetRightLabel(e) {
    return this;
  }
  ...
  Draw() {
    ...
    (this._itemText.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      (this._itemText.Caption = e),
      (this._arrowLeft.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      (this._arrowRight.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      (this._arrowLeft.Pos = new Mt(380 - t + this.Offset.X + this.Parent.WidthOffset, this._arrowLeft.Pos.Y)),
      this.Selected ? (this._arrowLeft.Draw(), this._arrowRight.Draw(), (this._itemText.Pos = new Mt(405 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y))) : (this._itemText.Pos = new Mt(420 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y)),
      this._itemText.Draw();
  }
}
Number.isInteger =
...
class xt extends At {
  constructor(e, t = "", _ = 0, i = 10, n = 0, a = null) {
    super(e, t, a), (this._currentOffset = 0), (this._leftMoveThreshold = 1), (this._rightMoveThreshold = 1), (this._lowerThreshold = 0), (this._upperThreshold = 10), (this._preCaptionText = ""), (this._postCaptionText = ""), (this.LowerThreshold = _), (this.UpperThreshold = _ > i ? _ : i), (this.SelectedValue = n < _ || n > i ? _ : n), (this._arrowLeft = new Lt("commonmenu", "arrowleft", new Mt(110, 105), new Ot(30, 30))), (this._arrowRight = new Lt("commonmenu", "arrowright", new Mt(280, 105), new Ot(30, 30))), (this._itemText = new Tt("", new Mt(290, 104), 0.35, Rt.White, pt.ChaletLondon, ut.Right));
  }
  get PreCaptionText() {
  ...
  set PreCaptionText(e) {
    ...
    if ("string" != typeof e) throw new Error("The pre caption text must be a string");
    (this._preCaptionText = e), (this._currentOffset = kt.GetTextWidth(this.PreCaptionText + this._selectedValue.toString() + this.PostCaptionText, this._itemText && this._itemText.Font ? this._itemText.Font : 0, 0.35));
  }
  get PostCaptionText() {
  ...
  set PostCaptionText(e) {
    ...
    if ("string" != typeof e) throw new Error("The post caption text must be a string");
    (this._postCaptionText = e), (this._currentOffset = kt.GetTextWidth(this.PreCaptionText + this._selectedValue.toString() + this.PostCaptionText, this._itemText && this._itemText.Font ? this._itemText.Font : 0, 0.35));
  }
  ...
  set LowerThreshold(e) {
    if ("number" != typeof e && !e) throw new Error("The lower threshold can't be null");
    (this._lowerThreshold = e), this.SelectedValue < e && (this.SelectedValue = e);
  }
  get UpperThreshold() {
    return this._upperThreshold;
  }
  set UpperThreshold(e) {
    if ("number" != typeof e && !e) throw new Error("The upper threshold can't be null");
    (this._upperThreshold = e), this.SelectedValue > e && (this.SelectedValue = e);
  }
  get SelectedValue() {
    return this._selectedValue;
  }
  set SelectedValue(e) {
    if (e < this._lowerThreshold || e > this._upperThreshold) throw new Error("The value can not be outside the lower or upper limits");
    var t;
    (this._selectedValue = ((t = e), Number.isInteger(t) ? t : parseFloat(t.toFixed(10)))), (this._currentOffset = kt.GetTextWidth(this.PreCaptionText + this._selectedValue.toString() + this.PostCaptionText, this._itemText && this._itemText.Font ? this._itemText.Font : 0, this._itemText && this._itemText.Scale ? this._itemText.Scale : 0.35));
  }
  SetVerticalPosition(e) {
    (this._arrowLeft.Pos = new Mt(300 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)), (this._arrowRight.Pos = new Mt(400 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)), (this._itemText.Pos = new Mt(300 + this.Offset.X + this.Parent.WidthOffset, e + 147 + this.Offset.Y)), super.SetVerticalPosition(e);
  }
  ...
  Draw() {
    ...
    (this._itemText.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      ...
      (this._arrowLeft.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      (this._arrowRight.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
      (this._arrowLeft.Pos = new Mt(380 - e + this.Offset.X + this.Parent.WidthOffset, this._arrowLeft.Pos.Y)),
      this.Selected ? (this._arrowLeft.Draw(), this._arrowRight.Draw(), (this._itemText.Pos = new Mt(405 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y))) : (this._itemText.Pos = new Mt(420 + this.Offset.X + this.Parent.WidthOffset, this._itemText.Pos.Y)),
      this._itemText.Draw();
  }
}
class Nt extends At {
  constructor(e, t, _, i = "", n = !1, a = null) {
    super(e, i, a), (this._items = t), (this._arrowLeft = new Lt("commonmenutu", "arrowleft", new Mt(0, 105), new Ot(15, 15))), (this._arrowRight = new Lt("commonmenutu", "arrowright", new Mt(0, 105), new Ot(15, 15))), (this._rectangleBackground = new It(new Mt(0, 0), new Ot(150, 9), new Rt(4, 32, 57, 255))), (this._rectangleSlider = new It(new Mt(0, 0), new Ot(75, 9), new Rt(57, 116, 200, 255))), (this._rectangleDivider = new It(new Mt(0, 0), new Ot(2.5, 20), n ? Rt.WhiteSmoke : Rt.Transparent)), (this.Index = _);
  }
  get Index() {
  ...
  SetVerticalPosition(e) {
    (this._rectangleBackground.Pos = new Mt(250 + this.Offset.X + this.Parent.WidthOffset, e + 158.5 + this.Offset.Y)), (this._rectangleSlider.Pos = new Mt(250 + this.Offset.X + this.Parent.WidthOffset, e + 158.5 + this.Offset.Y)), (this._rectangleDivider.Pos = new Mt(323.5 + this.Offset.X + this.Parent.WidthOffset, e + 153 + this.Offset.Y)), (this._arrowLeft.Pos = new Mt(235 + this.Offset.X + this.Parent.WidthOffset, 155.5 + e + this.Offset.Y)), (this._arrowRight.Pos = new Mt(400 + this.Offset.X + this.Parent.WidthOffset, 155.5 + e + this.Offset.Y)), super.SetVerticalPosition(e);
  }
  IndexToItem(e) {
    return this._items[e];
  }
  Draw() {
    super.Draw(), (this._arrowLeft.Color = this.Enabled ? (this.Selected ? Rt.Black : Rt.WhiteSmoke) : new Rt(163, 159, 148)), (this._arrowRight.Color = this.Enabled ? (this.Selected ? Rt.Black : Rt.WhiteSmoke) : new Rt(163, 159, 148));
    let e = ((this._rectangleBackground.Size.Width - this._rectangleSlider.Size.Width) / (this._items.length - 1)) * this.Index;
    (this._rectangleSlider.Pos = new Mt(250 + this.Offset.X + e + +this.Parent.WidthOffset, this._rectangleSlider.Pos.Y)), this.Selected && (this._arrowLeft.Draw(), this._arrowRight.Draw()), this._rectangleBackground.Draw(), this._rectangleSlider.Draw(), this._rectangleDivider.Draw();
  }
  SetRightBadge(e) {}
  SetRightLabel(e) {}
}
class Bt extends Dt {
  ...
  Draw(e) {
    ...
    for (var s of (y.drawRect(n, a, _, i, this.Color.R, this.Color.G, this.Color.B, this.Color.A, !1), this.Items)) s.Draw(new Ot(this.Pos.X + e.Width, this.Pos.Y + e.Height));
  }
}
class Ft {
...
class Wt {
  constructor(e) {
    (this._handle = 0), (this.scaleForm = e), (this._handle = R(this.scaleForm));
  }
  get handle() {
    return this._handle;
  }
      ...
      t.forEach((e) => {
        switch (typeof e) {
          ...
          case "boolean":
            ...
            break;
          default:
            n(`Unknown argument type ${typeof e} = ${e.toString()} passed to scaleform with handle ${this._handle}`);
        }
      }));
  }
  callFunction(e, ...t) {
  ...
  recreate() {
    this.isValid && this.isLoaded && (T(this._handle), (this._handle = R(this.scaleForm)));
  }
  destroy() {
...
class Vt {
  ...
  static Load() {
    null != this._delayedTransitionInTimeout && (_(this._delayedTransitionInTimeout), (this._delayedTransitionInTimeout = null));
  }
  ...
  static ShowComplexCustomShard(e, t = 5e3) {
    this.Load(), this._messageVisible ? (this.TransitionOut(), this.SetDelayedTransition(() => e(), t)) : this.TransitionIn(e, t);
  }
  static TransitionOut() {
    this._messageVisible &&
      (null != this._transitionOutTimeout && (_(this._transitionOutTimeout), (this._transitionOutTimeout = null)),
      null != this._transitionOutFinishedTimeout && (_(this._transitionOutFinishedTimeout), (this._transitionOutFinishedTimeout = null)),
...
(Vt._messageVisible = !1), (Vt._transitionOutTimeout = null), (Vt._transitionOutFinishedTimeout = null), (Vt._delayedTransitionInTimeout = null), (Vt._scaleform = null), (Vt._transitionOutTimeMs = 500), (Vt._transitionOutAnimName = null);
(class extends Vt {
  static Initialize(e, _) {
    super.Initialize(e, _), t(() => this.Render());
  }
  static ShowMissionPassedMessage(e, t = "", _ = 5e3) {
    this.ShowCustomShard("SHOW_MISSION_PASSED_MESSAGE", _, e, t, 100, !0, 0, !0);
  }
  ...
  static ShowMpMessageLarge(e, t = "", _ = 5e3) {
    this.ShowComplexCustomShard(() => {
      this.Scaleform.callFunction("SHOW_CENTERED_MP_MESSAGE_LARGE", e, t, 100, !0, 100), this.Scaleform.callFunction("TRANSITION_IN");
    }, _);
  }
...
class zt extends At {
  constructor(e, t, _ = "", i = null, a = null) {
    super(e, _, a),
      ...
      this.isVariableFunction(t) || n(`[UIMenuDynamicListItem] ${e} is not created with a valid selectionChangeHandler, needs to be function. Please see docs.`),
      this.isVariableFunction(i) || n(`[UIMenuDynamicListItem] ${e} is not created with a valid selectedStartValueHandler, needs to be function. Please see docs.`),
      (this.SelectionChangeHandler = t),
      (this._selectedStartValueHandler = i),
      (this._arrowLeft = new Lt("commonmenu", "arrowleft", new Mt(110, 105), new Ot(30, 30))),
      (this._arrowRight = new Lt("commonmenu", "arrowright", new Mt(280, 105), new Ot(30, 30))),
      (this._itemText = new Tt("", new Mt(290, 104), 0.35, Rt.White, pt.ChaletLondon, ut.Right));
  }
  ...
  set PreCaptionText(e) {
    if (!e) throw new Error("The pre caption text can't be null");
    if ("string" != typeof e) throw new Error("The pre caption text must be a string");
    (this._precaptionText = e), (this._currentOffset = kt.GetTextWidth(this.PreCaptionText + this._selectedValue, this._itemText && this._itemText.Font ? this._itemText.Font : 0, 0.35));
  }
  get SelectedValue() {
    return this._selectedValue;
  }
  set SelectedValue(e) {
    (this._selectedValue = e), null != e && (this._currentOffset = kt.GetTextWidth(this.PreCaptionText + this._selectedValue, this._itemText && this._itemText.Font ? this._itemText.Font : 0, this._itemText && this._itemText.Scale ? this._itemText.Scale : 0.35));
  }
  SetVerticalPosition(e) {
    (this._arrowLeft.Pos = new Mt(300 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)), (this._arrowRight.Pos = new Mt(400 + this.Offset.X + this.Parent.WidthOffset, 147 + e + this.Offset.Y)), (this._itemText.Pos = new Mt(300 + this.Offset.X + this.Parent.WidthOffset, e + 147 + this.Offset.Y)), super.SetVerticalPosition(e);
  }
  ...
  Draw() {
    super.Draw(), null == this._selectedValue && (null != this._selectedStartValueHandler ? (this.SelectedValue = this._selectedStartValueHandler()) : (this._selectedValue = ""));
    const e = this._currentOffset;
    (this._itemText.Color = this.Enabled ? (this.Selected ? this.HighlightedForeColor : this.ForeColor) : new Rt(163, 159, 148)),
...
class jt {
  constructor(e, _, i, n, a) {
    (this._visible = !0),
      ...
      (this._mainMenu = new Bt(new Mt(0, 0), new Ot(700, 500), new Rt(0, 0, 0, 0))),
      (this._bannerSprite = new Lt(this._spriteLibrary, this._spriteName, new Mt(0 + this._offset.X, 0 + this._offset.Y), new Ot(431, 107))),
      this._mainMenu.addItem((this._titleResText = new Tt(e, new Mt(215 + this._offset.X, 20 + this._offset.Y), this._defaultTitleScale, new Rt(255, 255, 255), 1, ut.Centered))),
      "" !== _ && (this._mainMenu.addItem(new It(new Mt(0 + this._offset.X, 107 + this._offset.Y), new Ot(431, 37), new Rt(0, 0, 0, 255))), this._mainMenu.addItem((this._subtitleResText = new Tt(_, new Mt(8 + this._offset.X, 110 + this._offset.Y), 0.35, new Rt(255, 255, 255), 0, ut.Left))), _.startsWith("~") && (this._counterPretext = _.substr(0, 3)), (this._counterText = new Tt("", new Mt(425 + this._offset.X, 110 + this._offset.Y), 0.35, new Rt(255, 255, 255), 0, ut.Right)), (this._extraOffset += 37)),
      (this._upAndDownSprite = new Lt("commonmenu", "shop_arrows_upanddown", new Mt(190 + this._offset.X, 147 + 37 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset), new Ot(50, 50))),
      (this._extraRectangleUp = new It(new Mt(0 + this._offset.X, 144 + 38 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset), new Ot(431, 18), new Rt(0, 0, 0, 200))),
      (this._extraRectangleDown = new It(new Mt(0 + this._offset.X, 162 + 38 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset), new Ot(431, 18), new Rt(0, 0, 0, 200))),
      (this._descriptionBar = new It(new Mt(this._offset.X, 123), new Ot(431, 4), Rt.Black)),
      (this._descriptionRectangle = new Lt("commonmenu", "gradient_bgd", new Mt(this._offset.X, 127), new Ot(431, 30))),
      (this._descriptionText = new Tt("", new Mt(this._offset.X + 5, 125), 0.35, new Rt(255, 255, 255, 255), pt.ChaletLondon, ut.Left)),
      (this._descriptionText.Wrap = 400),
      (this._background = new Lt("commonmenu", "gradient_bgd", new Mt(this._offset.X, 144 + this._offset.Y - 37 + this._extraOffset), new Ot(290, 25))),
      (this._visible = !1),
  ...
  set Visible(e) {
    if (((this._visible = e), Ft.PlaySound(this.AUDIO_BACK, this.AUDIO_LIBRARY), this.UpdateScaleform(), e && this.UpdateDescriptionCaption(), !0 !== this._justOpenedFromPool))
      if (e) {
        if (((this._justOpened = !0), this.MenuOpen.emit(), null === this.ParentMenu && !Yt.includes(this) && this !== this._poolOpening)) {
          const e = Yt.length ? Yt[Yt.length - 1] : null;
          Yt.push(this), e !== this._poolOpening && null !== e && ((e._justClosedFromPool = !0), (e.Visible = !1));
        }
      } else {
        if (!0 === this._justClosedFromPool) return void (this._justClosedFromPool = !1);
        null === this.ParentMenu && Yt.includes(this) && Yt.length && (Yt[Yt.length - 1] === this && (Yt.pop(), (this._justOpenedFromPool = !0), Yt.length || (this._poolOpening = null)), Yt.length && ((this._poolOpening = Yt[Yt.length - 1]), (Yt[Yt.length - 1].Visible = !0))), 0 === Yt.length && y.setMouseCursorStyle(1);
      }
  ...
  set CurrentSelection(e) {
    (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1), (this._activeItem = this._maxMenuItems - (this._maxMenuItems % this.MenuItems.length) + e), this.CurrentSelection > this._maxItem ? ((this._maxItem = this.CurrentSelection), (this._minItem = this.CurrentSelection - this._maxItemsOnScreen)) : this.CurrentSelection < this._minItem && ((this._maxItem = this._maxItemsOnScreen + this.CurrentSelection), (this._minItem = this.CurrentSelection)), this.IndexChange.emit(this.CurrentSelection, this.MenuItems[this._activeItem % this.MenuItems.length]), this.UpdateDescriptionCaption();
  }
  ...
  SetRectangleBannerType(e) {
    (this._bannerSprite = null), (this._bannerRectangle = e), (this._bannerRectangle.Pos = new Mt(this._offset.X, this._offset.Y)), (this._bannerRectangle.Size = new Ot(431 + this.WidthOffset, 107));
  }
  AddSpriteBannerType(e) {
    (this._bannerSprite = e), (this._bannerSprite.Size = new Ot(431 + this.WidthOffset, 107)), (this._bannerSprite.Pos = new Mt(this._offset.X, this._offset.Y));
  }
  SetNoBannerType() {
    (this._bannerSprite = null), (this._bannerRectangle = new It(new Mt(this._offset.X, this._offset.Y), new Ot(431 + this.WidthOffset, 107), new Rt(0, 0, 0, 0)));
  }
  RemoveInstructionalButton(e) {
    for (let t = 0; t < this._instructionalButtons.length; t++) this._instructionalButtons[t] === e && this._instructionalButtons.splice(t, 1);
  }
  RecalculateDescriptionPosition() {
    const e = this.MenuItems.length > this._maxItemsOnScreen + 1 ? this._maxItemsOnScreen + 2 : this.MenuItems.length;
    (this._descriptionBar.Size = new Ot(431 + this.WidthOffset, 4)), (this._descriptionRectangle.Size = new Ot(431 + this.WidthOffset, 30)), (this._descriptionBar.Pos = new Mt(this._offset.X, 112 + this._extraOffset + this._offset.Y)), (this._descriptionRectangle.Pos = new Mt(this._offset.X, 112 + this._extraOffset + this._offset.Y)), (this._descriptionText.Pos = new Mt(this._offset.X + 8, 118 + this._extraOffset + this._offset.Y)), (this._descriptionBar.Pos = new Mt(this._offset.X, 38 * e + this._descriptionBar.Pos.Y)), (this._descriptionRectangle.Pos = new Mt(this._offset.X, 38 * e + this._descriptionRectangle.Pos.Y)), (this._descriptionText.Pos = new Mt(this._offset.X + 8, 38 * e + this._descriptionText.Pos.Y));
  }
  SetMenuWidthOffset(e) {
    (this.WidthOffset = e), null != this._bannerSprite && (this._bannerSprite.Size = new Ot(431 + this.WidthOffset, 107)), (this._mainMenu.Items[0].pos = new Mt((this.WidthOffset + this._offset.X + 431) / 2, 20 + this._offset.Y)), this._counterText && (this._counterText.Pos = new Mt(425 + this._offset.X + e, 110 + this._offset.Y)), this._mainMenu.Items.length >= 2 && (this._mainMenu.Items[1].size = new Ot(431 + this.WidthOffset, 37)), null != this._bannerRectangle && (this._bannerRectangle.Size = new Ot(431 + this.WidthOffset, 107));
  }
  AddItem(e) {
    this._justOpened && (this._justOpened = !1), (e.Offset = this._offset), (e.Parent = this), e.SetVerticalPosition(25 * this.MenuItems.length - 37 + this._extraOffset), this.MenuItems.push(e), this.RefreshIndex();
  }
  RemoveItem(e) {
  ...
  RefreshIndex() {
    if (0 == this.MenuItems.length) return (this._activeItem = this._maxMenuItems), (this._maxItem = this._maxItemsOnScreen), void (this._minItem = 0);
    for (let e = 0; e < this.MenuItems.length; e++) this.MenuItems[e].Selected = !1;
    (this._activeItem = this._maxMenuItems - (this._maxMenuItems % this.MenuItems.length)), (this._maxItem = this._maxItemsOnScreen), (this._minItem = 0), this._visible && this.UpdateDescriptionCaption();
  }
  Clear() {
  ...
  GoLeft() {
    if ((this.MenuItems[this.CurrentSelection] instanceof Ht || this.MenuItems[this.CurrentSelection] instanceof xt || this.MenuItems[this.CurrentSelection] instanceof zt || this.MenuItems[this.CurrentSelection] instanceof Nt) && this.MenuItems[this.CurrentSelection].Enabled)
      if (this.MenuItems[this.CurrentSelection] instanceof Ht) {
        ...
        e.Index--, Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY), this.ListChange.emit(e, e.Index), this.UpdateDescriptionCaption();
      } else if (this.MenuItems[this.CurrentSelection] instanceof xt) {
        const e = this.MenuItems[this.CurrentSelection];
        e.SelectedValue <= e.LowerThreshold ? (e.SelectedValue = e.UpperThreshold) : (e.SelectedValue -= e.LeftMoveThreshold), Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY), this.AutoListChange.emit(e, e.SelectedValue, yt.Left), this.UpdateDescriptionCaption();
      } else if (this.MenuItems[this.CurrentSelection] instanceof zt) {
        const e = this.MenuItems[this.CurrentSelection];
        e.SelectionChangeHandlerPromise(e, e.SelectedValue, yt.Left).then((t) => {
          (e.SelectedValue = t), this.DynamicListChange.emit(e, e.SelectedValue, yt.Left);
        }),
        ...
        const e = this.MenuItems[this.CurrentSelection];
        (e.Index = e.Index - 1), Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY), this.SliderChange.emit(e, e.Index, e.IndexToItem(e.Index)), this.UpdateDescriptionCaption();
      }
  }
  GoRight() {
    if ((this.MenuItems[this.CurrentSelection] instanceof Ht || this.MenuItems[this.CurrentSelection] instanceof xt || this.MenuItems[this.CurrentSelection] instanceof zt || this.MenuItems[this.CurrentSelection] instanceof Nt) && this.MenuItems[this.CurrentSelection].Enabled)
      if (this.MenuItems[this.CurrentSelection] instanceof Ht) {
        ...
        const e = this.MenuItems[this.CurrentSelection];
        e.SelectedValue >= e.UpperThreshold ? (e.SelectedValue = e.LowerThreshold) : (e.SelectedValue += e.RightMoveThreshold), Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY), this.AutoListChange.emit(e, e.SelectedValue, yt.Right), this.UpdateDescriptionCaption();
      } else if (this.MenuItems[this.CurrentSelection] instanceof zt) {
        const e = this.MenuItems[this.CurrentSelection];
        e.SelectionChangeHandlerPromise(e, e.SelectedValue, yt.Right).then((t) => {
          (e.SelectedValue = t), this.DynamicListChange.emit(e, e.SelectedValue, yt.Right);
        }),
          Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY),
          this.UpdateDescriptionCaption();
      } else if (this.MenuItems[this.CurrentSelection] instanceof Nt) {
        const e = this.MenuItems[this.CurrentSelection];
        e.Index++, Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY), this.SliderChange.emit(e, e.Index, e.IndexToItem(e.Index)), this.UpdateDescriptionCaption();
      }
  }
  SelectItem() {
    if (!this.MenuItems[this.CurrentSelection].Enabled) return void Ft.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY);
    const e = this.MenuItems[this.CurrentSelection];
    if (this.MenuItems[this.CurrentSelection] instanceof Ut) (e.Checked = !e.Checked), Ft.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY), this.CheckboxChange.emit(e, e.Checked);
    else if ((Ft.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY), this.ItemSelect.emit(e, this.CurrentSelection), this.Children.has(e.Id))) {
  ...
  HasCurrentSelectionChildren() {
    const e = this.MenuItems[this.CurrentSelection];
    return !!(this.MenuItems[this.CurrentSelection] instanceof At && this.Children.has(e.Id));
  }
  IsMouseInListItemArrows(e, t, _) {
    y.beginTextCommandGetWidth("jamyfafi"), y.addTextComponentSubstringPlayerName(e.Text);
    let i = kt.ResolutionMaintainRatio,
      n = (i.Width / i.Height) * 1080;
    const a = 5 + y.endTextCommandGetWidth(!1) * n * 0.35 + 10,
      s = 431 - a;
    return kt.IsMouseInBounds(t, new Ot(a, 38)) ? 1 : kt.IsMouseInBounds(new Mt(t.X + a, t.Y), new Ot(s, 38)) ? 2 : 0;
  }
  ProcessMouse() {
    ...
    let e = this.MenuItems.length - 1,
      t = 0;
    this.MenuItems.length > this._maxItemsOnScreen + 1 && (e = this._maxItem), kt.IsMouseInBounds(new Mt(0, 0), new Ot(30, 1080)) && this._mouseEdgeEnabled ? (y.setGameplayCamRelativeHeading(y.getGameplayCamRelativeHeading() + 5), y.setMouseCursorSprite(6)) : kt.IsMouseInBounds(new Mt(kt.ResolutionMaintainRatio.Width - 30, 0), new Ot(30, 1080)) && this._mouseEdgeEnabled ? (y.setGameplayCamRelativeHeading(y.getGameplayCamRelativeHeading() - 5), y.setMouseCursorSprite(7)) : this._mouseEdgeEnabled && y.setMouseCursorSprite(1);
    for (let _ = this._minItem; _ <= e; _++) {
      ...
      if (kt.IsMouseInBounds(new Mt(e, i), new Ot(n, a))) {
        s.Hovered = !0;
        const t = this.IsMouseInListItemArrows(this.MenuItems[_], new Mt(e, i), 0);
        if ((s.Hovered && 1 == t && (this.MenuItems[_] instanceof Ht || this.MenuItems[_] instanceof xt || this.MenuItems[_] instanceof zt) && y.setMouseCursorSprite(5), y.isControlJustReleased(0, 24) || y.isDisabledControlJustReleased(0, 24)))
          if (s.Selected && s.Enabled)
            if ((this.MenuItems[_] instanceof Ht || this.MenuItems[_] instanceof xt || this.MenuItems[_] instanceof zt) && this.IsMouseInListItemArrows(this.MenuItems[_], new Mt(e, i), 0) > 0)
              switch (t) {
                case 1:
                  Ft.PlaySound(this.AUDIO_SELECT, this.AUDIO_LIBRARY), this.MenuItems[_].fireEvent(), this.ItemSelect.emit(this.MenuItems[_], _);
                  break;
                case 2:
                  let e = this.MenuItems[_];
                  (null == e.Collection ? e.Items.Count : e.Collection.Count) > 0 && (e.Index++, Ft.PlaySound(this.AUDIO_LEFTRIGHT, this.AUDIO_LIBRARY), this.ListChange.emit(e, e.Index));
              }
            else this.SelectItem();
          else s.Selected ? !s.Enabled && s.Selected && Ft.PlaySound(this.AUDIO_ERROR, this.AUDIO_LIBRARY) : ((this.CurrentSelection = _), Ft.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY), this.IndexChange.emit(this.CurrentSelection, this.MenuItems[this._activeItem % this.MenuItems.length]), this.SelectItem(), this.UpdateDescriptionCaption(), this.UpdateScaleform());
      } else s.Hovered = !1;
      t++;
    }
    const _ = 144 + 38 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset + this._safezoneOffset.Y,
      i = this._safezoneOffset.X + this._offset.X;
    this.MenuItems.length <= this._maxItemsOnScreen + 1 || (kt.IsMouseInBounds(new Mt(i, _), new Ot(431 + this.WidthOffset, 18)) ? ((this._extraRectangleUp.Color = new Rt(30, 30, 30, 255)), (y.isControlJustPressed(0, 24) || y.isDisabledControlJustPressed(0, 24)) && (this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoUpOverflow() : this.GoUp())) : (this._extraRectangleUp.Color = new Rt(0, 0, 0, 200)), kt.IsMouseInBounds(new Mt(i, _ + 18), new Ot(431 + this.WidthOffset, 18)) ? ((this._extraRectangleDown.Color = new Rt(30, 30, 30, 255)), (y.isControlJustPressed(0, 24) || y.isDisabledControlJustPressed(0, 24)) && (this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoDownOverflow() : this.GoDown())) : (this._extraRectangleDown.Color = new Rt(0, 0, 0, 200)));
  }
  ProcessControl() {
    this.Visible &&
      (this._justOpened
        ...
        : (y.isControlJustReleased(0, 177) && this.GoBack(),
          0 != this.MenuItems.length &&
            (y.isControlPressed(0, 172) && this._lastUpDownNavigation + 120 < Date.now()
              ? ((this._lastUpDownNavigation = Date.now()), this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoUpOverflow() : this.GoUp(), this.UpdateScaleform())
              : y.isControlJustReleased(0, 172)
              ? (this._lastUpDownNavigation = 0)
              : y.isControlPressed(0, 173) && this._lastUpDownNavigation + 120 < Date.now()
              ? ((this._lastUpDownNavigation = Date.now()), this.MenuItems.length > this._maxItemsOnScreen + 1 ? this.GoDownOverflow() : this.GoDown(), this.UpdateScaleform())
              : y.isControlJustReleased(0, 173)
              ? (this._lastUpDownNavigation = 0)
              : y.isControlPressed(0, 174) && this._lastLeftRightNavigation + 100 < Date.now()
              ? ((this._lastLeftRightNavigation = Date.now()), this.GoLeft())
              : y.isControlJustReleased(0, 174)
              ? (this._lastLeftRightNavigation = 0)
              : y.isControlPressed(0, 175) && this._lastLeftRightNavigation + 100 < Date.now()
    ...
    this.MenuItems.length <= this._maxItemsOnScreen + 1 ||
      (this._activeItem % this.MenuItems.length <= this._minItem
        ? this._activeItem % this.MenuItems.length == 0
          ? ((this._minItem = this.MenuItems.length - this._maxItemsOnScreen - 1), (this._maxItem = this.MenuItems.length - 1), (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1), (this._activeItem = this._maxMenuItems - (this._maxMenuItems % this.MenuItems.length)), (this._activeItem += this.MenuItems.length - 1), (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0))
  ...
  GoUp() {
    this.MenuItems.length > this._maxItemsOnScreen + 1 || ((this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1), this._activeItem--, (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0), Ft.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY), this.IndexChange.emit(this.CurrentSelection, this.MenuItems[this._activeItem % this.MenuItems.length]), this.UpdateDescriptionCaption());
  }
  GoDownOverflow() {
    this.MenuItems.length <= this._maxItemsOnScreen + 1 ||
      (this._activeItem % this.MenuItems.length >= this._maxItem
        ? this._activeItem % this.MenuItems.length == this.MenuItems.length - 1
          ? ((this._minItem = 0), (this._maxItem = this._maxItemsOnScreen), (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1), (this._activeItem = this._maxMenuItems - (this._maxMenuItems % this.MenuItems.length)), (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0))
          : (this._minItem++, this._maxItem++, (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1), this._activeItem++, (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0))
        : ((this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !1), this._activeItem++, (this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0)),
      Ft.PlaySound(this.AUDIO_UPDOWN, this.AUDIO_LIBRARY),
      this.IndexChange.emit(this.CurrentSelection, this.MenuItems[this._activeItem % this.MenuItems.length]),
  ...
  GoBack() {
    null != this.ParentMenu ? ((this.Visible = !1), (this.ParentMenu.Visible = !0), this.MenuChange.emit(this.ParentMenu, !1), this.MenuClose.emit(!1)) : this.CloseableByUser && ((this.Visible = !1), this.CleanUp(!0), this.MenuClose.emit(!1));
  }
  BindMenuToItem(e, t) {
  ...
  ReleaseMenuFromItem(e) {
    ...
    const t = this.Children.get(e.Id);
    return (t.ParentItem = null), (t.ParentMenu = null), this.Children.delete(e.Id), !0;
  }
  UpdateDescriptionCaption() {
    this.MenuItems.length && ((this._descriptionText.Caption = this.MenuItems[this._activeItem % this.MenuItems.length].Description), (this._descriptionText.Wrap = 400), this._recalculateDescriptionNextFrame++);
  }
  CalculateDescription() {
    if (!(this.MenuItems.length <= 0) && (this._recalculateDescriptionNextFrame > 0 && this._recalculateDescriptionNextFrame--, this.RecalculateDescriptionPosition(), this.MenuItems.length > 0 && this._descriptionText.Caption && "" !== this.MenuItems[this._activeItem % this.MenuItems.length].Description.trim())) {
      const e = kt.GetLineCount(this._descriptionText.Caption, this._descriptionText.Pos, this._descriptionText.Font, this._descriptionText.Scale, this._descriptionText.Wrap);
      (this._descriptionRectangle.Size = new Ot(431 + this.WidthOffset, 25 * e + 15)), 0 === e && this._recalculateDescriptionNextFrame++;
    }
  }
  UpdateScaleform() {
    if (!this.Visible || !this._buttonsEnabled) return;
    this._instructionalButtonsScaleform.callFunction("CLEAR_ALL"), this._instructionalButtonsScaleform.callFunction("TOGGLE_MOUSE_BUTTONS", 0), this._instructionalButtonsScaleform.callFunction("CREATE_CONTAINER"), this._instructionalButtonsScaleform.callFunction("SET_DATA_SLOT", 0, y.getControlInstructionalButtonsString(2, ft.PhoneSelect, !1), this.SelectTextLocalized), this._instructionalButtonsScaleform.callFunction("SET_DATA_SLOT", 1, y.getControlInstructionalButtonsString(2, ft.PhoneCancel, !1), this.BackTextLocalized);
    let e = 2;
    this._instructionalButtons
      .filter((e) => null == e.ItemBind || this.MenuItems[this.CurrentSelection] == e.ItemBind)
      .forEach((t) => {
        this._instructionalButtonsScaleform.callFunction("SET_DATA_SLOT", e, t.GetButtonId(), t.Text), e++;
      }),
      this._instructionalButtonsScaleform.callFunction("DRAW_INSTRUCTIONAL_BUTTONS", -1);
  }
  render() {
    if (!this.Visible) return;
    this._buttonsEnabled && (y.drawScaleformMovieFullscreen(this._instructionalButtonsScaleform.handle, 255, 255, 255, 255, 0), y.hideHudComponentThisFrame(6), y.hideHudComponentThisFrame(7), y.hideHudComponentThisFrame(9)),
      this._justOpened && (null == this._bannerSprite || this._bannerSprite.IsTextureDictionaryLoaded || this._bannerSprite.LoadTextureDictionary(), this._background.IsTextureDictionaryLoaded || this._background.LoadTextureDictionary(), this._descriptionRectangle.IsTextureDictionaryLoaded || this._descriptionRectangle.LoadTextureDictionary(), this._upAndDownSprite.IsTextureDictionaryLoaded || this._upAndDownSprite.LoadTextureDictionary(), this._recalculateDescriptionNextFrame || this._recalculateDescriptionNextFrame++),
      this._mainMenu.Draw(),
      this.ProcessMouse(),
      this.ProcessControl(),
      (this._background.Size = this.MenuItems.length > this._maxItemsOnScreen + 1 ? new Ot(431 + this.WidthOffset, 38 * (this._maxItemsOnScreen + 1)) : new Ot(431 + this.WidthOffset, 38 * this.MenuItems.length)),
      this._background.Draw(),
      this._recalculateDescriptionNextFrame && this.CalculateDescription(),
      this.MenuItems.length > 0 && ((this.MenuItems[this._activeItem % this.MenuItems.length].Selected = !0), "" !== this.MenuItems[this._activeItem % this.MenuItems.length].Description.trim() && (this._descriptionBar.Draw(), this._descriptionRectangle.Draw(), this._descriptionText.Draw()));
    let e = 0;
    if (this.MenuItems.length <= this._maxItemsOnScreen + 1) {
      for (const t of this.MenuItems) t.SetVerticalPosition(38 * e - 37 + this._extraOffset), t.Draw(), e++;
      this._counterText && this._counterOverride && ((this._counterText.Caption = this._counterPretext + this._counterOverride), this._counterText.Draw());
    } else {
      for (let t = this._minItem; t <= this._maxItem; t++) {
        let _ = this.MenuItems[t];
        _.SetVerticalPosition(38 * e - 37 + this._extraOffset), _.Draw(), e++;
      }
      if (((this._extraRectangleUp.Size = new Ot(431 + this.WidthOffset, 18)), (this._extraRectangleDown.Size = new Ot(431 + this.WidthOffset, 18)), (this._upAndDownSprite.Pos = new Mt(190 + this._offset.X + this.WidthOffset / 2, 147 + 37 * (this._maxItemsOnScreen + 1) + this._offset.Y - 37 + this._extraOffset)), this._extraRectangleUp.Draw(), this._extraRectangleDown.Draw(), this._upAndDownSprite.Draw(), this._counterText)) {
        if (this._counterOverride) this._counterText.Caption = this._counterPretext + this._counterOverride;
        else {
    ...
    null != this._bannerRectangle && this._bannerRectangle.Draw(), null != this._bannerSprite && this._bannerSprite.Draw();
  }
}
class Kt {
  constructor(e, t) {
    (this.pool = e), (this.menuObject = new jt("", t.toUpperCase(), new Mt(50, -57))), this.menuObject.SetNoBannerType(), this.menuObject.DisableInstructionalButtons(!0), this.menuObject.ItemSelect.on((e) => e.Data()), this.menuObject.CheckboxChange.on((e, t) => e.Data(t)), this.menuObject.DynamicListChange.on((e, t, _) => e.Data(t, _)), this.menuObject.ListChange.on((e, t) => e.Data(t)), this.pool.add(this.menuObject);
  }
  addItem(e, t = () => {}) {
...
var Xt, Jt, Zt;
!(function (e) {
  (e[(e.ChaletLondon = 0)] = "ChaletLondon"), (e[(e.HouseScript = 1)] = "HouseScript"), (e[(e.Monospace = 2)] = "Monospace"), (e[(e.ChaletComprimeCologne = 4)] = "ChaletComprimeCologne"), (e[(e.Pricedown = 7)] = "Pricedown");
})(Xt || (Xt = {})),
  (function (e) {
    (e[(e.Normal = 0)] = "Normal"), (e[(e.Repeat = 1)] = "Repeat"), (e[(e.StopLastFrame = 2)] = "StopLastFrame"), (e[(e.Upperbody = 16)] = "Upperbody"), (e[(e.EnablePlayerControl = 32)] = "EnablePlayerControl"), (e[(e.Cancelable = 120)] = "Cancelable");
  })(Jt || (Jt = {})),
  (function (e) {
    (e[(e.Free = -2)] = "Free"), (e[(e.Driver = -1)] = "Driver"), (e[(e.Passenger = 0)] = "Passenger"), (e[(e.LeftRear = 1)] = "LeftRear"), (e[(e.RightRear = 2)] = "RightRear");
  })(Zt || (Zt = {}));
const qt = new (class {
  constructor() {
  ...
  init() {
    m("network:sendCallback", (e, t) => this.callbacks[e](t)), m("world:setCloudHat", (e) => P(e, 0)), m("world:setCloudHatOpacity", (e) => A(e)), m("world:setArtificialLightsState", (e) => U(e)), m("player:teleportToEntity", (e) => (e instanceof h && e.vehicle ? E(h.local.scriptID, e.vehicle.scriptID, Zt.Free) : v(h.local.scriptID, e.pos.x, e.pos.y, e.pos.z)));
  }
  async callback(e, t = []) {
    return await new Promise((_) => {
      p("network:requestCallback", this.callbackID, e, t), (this.callbacks[this.callbackID] = _), this.callbackID++;
    });
  }
})();
class $t {
...
var Qt;
!(function (e) {
  (e[(e.ExtraSunny = 0)] = "ExtraSunny"), (e[(e.Clear = 1)] = "Clear"), (e[(e.Clouds = 2)] = "Clouds"), (e[(e.Smog = 3)] = "Smog"), (e[(e.Foggy = 4)] = "Foggy"), (e[(e.Overcast = 5)] = "Overcast"), (e[(e.Rain = 6)] = "Rain"), (e[(e.Thunder = 7)] = "Thunder"), (e[(e.Clearing = 8)] = "Clearing"), (e[(e.Neutral = 9)] = "Neutral"), (e[(e.Snow = 10)] = "Snow"), (e[(e.Blizzard = 11)] = "Blizzard"), (e[(e.Snowlight = 12)] = "Snowlight"), (e[(e.Xmas = 13)] = "Xmas"), (e[(e.Halloween = 14)] = "Halloween");
})(Qt || (Qt = {}));
const e_ = new (class {
  constructor() {
    this.handlers = {};
...
class __ extends $t {
  ...
  static async playAnimation(e, t, _ = Jt.Normal) {
    await t_.loadAnimationDict(e), q(h.local.scriptID, e, t, 8, 8, -1, _, 0, !1, !1, !0);
  }
  static teleportTo(e) {
...
class n_ extends i_ {
  ...
  drawThisFrame() {
    Q(this.centre), ee(0, this.scale), te(this.color.r, this.color.g, this.color.b, this.color.a), _e(this.font), ie(), ne("CELL_EMAIL_BCON"), this.text.match(/.{1,99}/g).forEach((e) => ae(e)), se(this.position[0], this.position[1], 0);
  }
}
class a_ extends i_ {
  constructor(e, t, _, i, n, a) {
  ...
  drawThisFrame() {
    ...
    let e = (1 / t_.getDistanceBetweenCoords(oe(), this.position)) * 20 * ((1 / re()) * 100);
    Q(!0), ee(0, this.scale * e), te(this.color.r, this.color.g, this.color.b, this.color.a), _e(this.font), ie(), le(this.position.x, this.position.y, this.position.z, 0), ne("CELL_EMAIL_BCON"), this.text.match(/.{1,99}/g).forEach((e) => ae(e)), se(0, 0, 0), ce();
  }
}
...
class f_ extends Kt {
  constructor(e, t) {
    super(e.pool, t), (this.parentMenu = e), (this.menuItem = new At(t)), (this.menuItem.RightLabel = "→→→"), this.parentMenu.addItem(this.menuItem), this.parentMenu.menuObject.AddSubMenu(this.menuObject, this.menuItem);
  }
  remove() {
    this.parentMenu.menuObject.RemoveItem(this.menuItem), this.pool.remove(this.menuObject);
  }
}
class y_ extends f_ {
  constructor(e, t) {
    super(e, t),
      this.addUserInputItem((this.customPropItem = new At("Spawn Custom Prop")), async () => t_.createProp(d(await t_.getUserInput()), h.local.pos, !0)),
      this.addUserInputItem((this.customTeleportItem = new At("Teleport To Coordinates")), async () => {
        let e = +(await t_.getUserInput()),
          t = +(await t_.getUserInput()),
          _ = +(await t_.getUserInput());
        v(h.local.scriptID, isNaN(e) ? 0 : e, isNaN(t) ? 0 : t, isNaN(_) ? 0 : _);
      }),
      this.addItem((this.teleportToMarkerItem = new Ut("Teleport To Marker", !0, "This enables the ~b~F7~s~ key to be used as a shortcut to teleport around the map."))),
      this.addItem((this.playerCoordsItem = new Ut("Show Player Coordinates")), (e) => (e ? e_.register("misc:drawPlayerCoord", () => new n_("~y~x~s~ " + h.local.pos.x.toFixed(3) + " ~y~y~s~ " + h.local.pos.y.toFixed(3) + " ~y~z~s~ " + h.local.pos.z.toFixed(3), [0.5, 0.95], 0.5, Xt.ChaletComprimeCologne, new u(255, 255, 255, 220), !0).drawThisFrame(), 0) : e_.clear("misc:drawPlayerCoord"))),
      this.addItem((this.playerSpeedItem = new Ut("Show Player Speed")), (e) => (e ? e_.register("misc:drawPlayerSpeed", () => new n_("~y~m/s~s~ " + me(h.local.scriptID).toFixed(3) + " ~y~km/h~s~ " + (3.6 * me(h.local.scriptID)).toFixed(3) + " ~y~mph~s~ " + (2.23694 * me(h.local.scriptID)).toFixed(3), [0.5, 0.9], 0.5, Xt.ChaletComprimeCologne, new u(255, 255, 255, 220), !0).drawThisFrame(), 0) : e_.clear("misc:drawPlayerSpeed"))),
      this.addItem((this.entitiesInfoItem = new Ut("Show Entity Info")), (e) =>
        e
          ? e_.register(
              "misc:drawEntityInfo",
              () => {
                g.all.forEach((e) => this.draw3DText("SCRIPTID " + e.scriptID + " - ID " + e.id + " - TYPE " + e.type + " - MODEL " + e.model + " - BODY " + he(e.scriptID) + " - ENGINE " + pe(e.scriptID) + " - PETROL TANK " + de(e.scriptID), e)), h.all.forEach((e) => this.draw3DText("SCRIPTID " + e.scriptID + ` - ID ${e.id} - TYPE ${e.type} - MODEL ` + e.model + " - HEALTH " + ue(e.scriptID) + " - ARMOR " + ge(e.scriptID), e));
              },
              0
            )
        ...
        e
          ? e_.register(
              ...
              () => {
                ...
                if (!e) return;
                let t = "~y~SCRIPTID " + e.scriptID + " - ID " + e.id + " - TYPE " + e.type + " - POS (" + e.pos.x.toFixed(3) + " - " + e.pos.y.toFixed(3) + ` - ${e.pos.z.toFixed(3)}) - ` + (fe(e.scriptID, !1) ? "DEAD" : "ALIVE") + " - DISTANCE " + t_.getDistanceBetweenCoords(h.local.pos, e.pos).toFixed(3);
                e instanceof g && (t = t.concat(" - " + (ye(e.scriptID, h.local.scriptID) ? "LOCKED" : "UNLOCKED"))), this.draw3DText(t, e);
              },
              0
            )
      ...
      this.addItem((this.hideHudItem = new Ut("Hide Game Hud")), (e) => {
        e ? e_.register("misc:hideHud", () => w_.getValues(s_).forEach((e) => Re(+e)), 0) : e_.clear("misc:hideHud"), Oe(!e);
      }),
      this.addItem((this.creditsItem = new At("About\\Credits", "Trainer made by ~b~Jayreen~s~ #1395 for ~b~alt:V~s~."))),
      (this.creditsItem.LeftBadge = mt.Heart),
      (this.creditsItem.RightLabel = "~h~ 1.0.3"),
      f("keyup", (e) => {
  ...
  draw3DText(e, t) {
    new a_(e, void 0, 0.06, Xt.ChaletComprimeCologne, new u(255, 255, 255, 220), t).drawThisFrame();
  }
}
class R_ extends f_ {
  constructor(e, t) {
    super(e, t), this.addItem((this.reloadPlayerListItem = new At("Reload Player List")), () => this.reloadPlayerList()), (this.reloadPlayerListItem.LeftBadge = mt.Alert), this.menuObject.MenuOpen.on(() => this.reloadPlayerList());
  }
  reloadPlayerList() {
    this.menuObject.MenuItems.length != h.all.length + 1 && (this.menuObject.MenuItems.splice(1), h.all.forEach((e) => new O_(this, `ID ${e.id} - ${e.name}`, e)));
  }
}
class O_ extends f_ {
  constructor(e, t, _) {
    super(e, t), this.addItem((this.hwIdHashItem = new At("HWID"))), this.addItem((this.hwIdExHashItem = new At("HWIDEX"))), this.addItem((this.socialIdItem = new At("SOCIALID"))), this.addItem((this.teleportToItem = new At("Teleport To Player")), () => t_.teleportPlayertoEntity(h.local, _)), this.addItem((this.teleportHereItem = new At("Teleport Here")), () => t_.teleportPlayertoEntity(_, h.local)), this.getIdentifiers(_);
  }
  async getIdentifiers(e) {
    let t = await t_.getPlayerIdentifiers(e);
    (this.hwIdHashItem.RightLabel = t[0]), (this.hwIdExHashItem.RightLabel = t[1]), (this.socialIdItem.RightLabel = t[2]);
  }
}
class M_ {
  static selectItem(e, t) {
    e.Parent.MenuItems.forEach((e) => this.deselectItem(e)), (e.Enabled = !1), (e.RightBadge = t);
  }
...
class S_ extends f_ {
  constructor(e, t) {
    super(e, t),
      ...
      this.addUserInputItem((this.animationItem = new At("Play Custom Animation", "Requires ~b~dictionary~s~ and ~b~name~s~.")), async () => await this.playAnimation(await t_.getUserInput(), await t_.getUserInput(), this.animationItem)),
      this.addItem((this.reviveItem = new At("Revive Player")), () => __.respawn()),
      this.addItem((this.healItem = new At("Heal Player")), () => __.heal()),
      this.addItem((this.invisibilityItem = new Ut("Player Invisibility")), (e) => Ce(h.local.scriptID, !e, !1)),
      this.addItem((this.godmodeItem = new Ut("Player Godmode")), (e) => __.setInvincible(h.local, e)),
      this.addItem((this.ragdollItem = new Ut("Disable Ragdoll")), (e) => ke(h.local.scriptID, !e)),
      this.addItem((this.collisionItem = new Ut("Disable Collision")), (e) => Le(h.local.scriptID, !e, !0)),
      this.addItem((this.infiniteStaminaItem = new Ut("Infinite Stamina")), (e) => (e ? e_.register("player:infiniteStamina", () => De(h.local.scriptID), 0) : e_.clear("player:infiniteStamina"))),
      this.addItem((this.superJumpItem = new Ut("Super Jump")), (e) => (e ? e_.register("player:superJump", () => Ie(h.local.scriptID), 0) : e_.clear("player:superJump"))),
      this.addItem((this.fastRunItem = new Ut("Fast Run")), (e) => Te(h.local.scriptID, e ? 1.49 : 1)),
      this.addItem((this.fastSwimItem = new Ut("Fast Swim")), (e) => Pe(h.local.scriptID, e ? 1.49 : 1)),
      this.addItem((this.thermalVisionItem = new Ut("Thermal Vision")), (e) => Ae(e)),
      this.addItem((this.nightVisionItem = new Ut("Night Vision")), (e) => Ue(e)),
  ...
  async playAnimation(e, t, _) {
    await __.playAnimation(e, t, Jt.EnablePlayerControl), M_.selectItem(_, mt.Tick), i(() => M_.deselectItem(_), 1e3 * ve(e, t));
  }
}
class b_ extends f_ {
  constructor(e, t) {
    super(e, t), this.addUserInputItem((this.customItem = new At("Custom Player Model")), async () => __.setModel(d(await t_.getUserInput()))), w_.getValues(o_).forEach((e) => this.addItem(new At(o_[+e].toUpperCase()), () => __.setModel(+e)));
  }
}
class C_ extends $t {
  static getColors(e) {
  ...
  static async driftModeOFF(e) {
    await qt.callback("vehicle:driftModeOFF", [e]);
  }
  static async driftModeON(e) {
    await qt.callback("vehicle:driftModeON", [e]);
  }
...
class k_ extends f_ {
  constructor(e, t) {
    super(e, t), (this.primaryColorMenu = new L_(this, "Primary Color", 0)), (this.secondaryColorMenu = new L_(this, "Secondary Color", 1)), (this.pearlescentColorMenu = new L_(this, "Pearlescent Color", 2)), (this.rimColorMenu = new L_(this, "Rim Color", 3));
  }
}
class L_ extends f_ {
  constructor(e, t, _) {
    super(e, t),
      ...
      this.menuObject.MenuOpen.on(() =>
        M_.selectItem(
          this.menuObject.MenuItems.find((e) => e.Text.replace(/\s+/g, "") == l_[C_.getColors(this.parentMenu.vehicle)[this.type]]),
          mt.Car
        )
      ),
      w_.getValues(l_).forEach((e) => {
        ...
        this.addItem(t, () => {
          C_.setColor(this.parentMenu.vehicle, this.type, +e), M_.selectItem(t, mt.Car);
        });
      });
  }
}
!(function (e) {
  (e[(e.Stock = -1)] = "Stock"), (e[(e.Sport = 0)] = "Sport"), (e[(e.Muscle = 1)] = "Muscle"), (e[(e.Lowrider = 2)] = "Lowrider"), (e[(e.SUV = 3)] = "SUV"), (e[(e.OffRoad = 4)] = "OffRoad"), (e[(e.Tuner = 5)] = "Tuner"), (e[(e.Bike = 6)] = "Bike"), (e[(e.HighEnd = 7)] = "HighEnd"), (e[(e.BennysOriginal = 8)] = "BennysOriginal"), (e[(e.BennysBespoke = 9)] = "BennysBespoke"), (e[(e.Race = 10)] = "Race"), (e[(e.Street = 11)] = "Street");
})(c_ || (c_ = {}));
class D_ extends f_ {
  constructor(e, t) {
    super(e, t), this.addItem((this.stockWheels = new At("Stock Wheels")), () => C_.setWheels(this.vehicle, 0, 0, 8 == Be(this.vehicle.scriptID))), (this.wheelsMenus = [new I_(this, "Sport", c_.Sport, 50), new I_(this, "Muscle", c_.Muscle, 36), new I_(this, "Lowrider", c_.Lowrider, 30), new I_(this, "SUV", c_.SUV, 38), new I_(this, "Off-Road", c_.OffRoad, 35), new I_(this, "Tuner", c_.Tuner, 48), new I_(this, "Bike", c_.Bike, 72), new I_(this, "High End", c_.HighEnd, 40), new I_(this, "Benny's Original", c_.BennysOriginal, 217), new I_(this, "Benny's Bespoke", c_.BennysBespoke, 217), new I_(this, "Race", c_.Race, 140), new I_(this, "Street", c_.Street, 210)]);
  }
}
class I_ extends f_ {
  constructor(e, t, _, i) {
    ...
    for (let e = 0; e < i; e++) {
      ...
      this.addItem(t, () => C_.setWheels(this.parentMenu.vehicle, _, e, 8 == Be(this.parentMenu.vehicle.scriptID)));
    }
  }
}
class T_ extends f_ {
  constructor(e, t) {
    super(e, t),
      ...
      (this.modMenus = [new A_(this, "Armor", r_.Armor), new A_(this, "Brakes", r_.Brakes), new A_(this, "Engine", r_.Engine), new A_(this, "Exhaust", r_.Exhaust), new A_(this, "Fenders", r_.Fenders), new A_(this, "Frame", r_.Frame), new A_(this, "Front Bumpers", r_.FrontBumpers), new A_(this, "Grille", r_.Grille), new A_(this, "Hood", r_.Hood), new A_(this, "Horn", r_.Horn), new A_(this, "Livery", r_.Livery), new A_(this, "Rear Bumpers", r_.RearBumper), new A_(this, "Rear Fenders", r_.RearFenders), new A_(this, "Roof", r_.Roof), new A_(this, "Skirts", r_.Skirts), new A_(this, "Spoiler", r_.Spoiler), new A_(this, "Suspension", r_.Suspension), new A_(this, "Transmission", r_.Transmission)].concat(this.bennysMenu.modMenus)),
      this.menuObject.MenuOpen.on(() => {
        Fe(this.vehicle.scriptID, 0), w_.getValues(r_).forEach((e) => this.modMenus.find((t) => t.mod == +e)?.init(this.vehicle));
      });
  }
}
class P_ extends f_ {
...
class A_ extends f_ {
  ...
  init(e) {
    if ((this.menuObject.Clear(), (this.numMods = Ge(e.scriptID, this.mod)), 0 == this.numMods)) M_.lockMenuItem(this.menuItem);
    else {
      ...
      M_.selectItem(this.menuObject.MenuItems[We(e.scriptID, this.mod) + 1], mt.Car);
    }
  }
}
class U_ extends f_ {
  constructor(e, t) {
    super(e, t),
      ...
      this.addItem((this.repairItem = new At("Repair Vehicle")), () => C_.repair(this.vehicle)),
      this.addItem((this.driftModeOFFItem = new At("Drift Mode OFF")), () => C_.driftModeOFF(this.vehicle)),
      this.addItem((this.driftModeONItem = new At("Drift Mode ON")), () => C_.driftModeON(this.vehicle)),
      this.addItem((this.cleanItem = new At("Clean Vehicle")), () => C_.clean(this.vehicle)),
      this.addItem((this.engineTorqueItem = new Ut("Enable Torque Multiplier")), (e) => (e ? e_.register("vehicle:torqueMultiplier", () => Ve(h.local.vehicle?.scriptID, this.multiplier), 0) : e_.clear("vehicle:torqueMultiplier"))),
      this.addItem(
        (this.torqueMultiplierItem = new zt(
          "Engine Torque Multiplier",
          (e, t, _) => (_ == yt.Right ? (this.multiplier = +t + 0.5) : (this.multiplier = +t - 0.5), "" + this.multiplier.toFixed(2)),
          void 0,
          () => "" + this.multiplier.toFixed(2)
        ))
      ),
      this.addItem((this.invisibilityItem = new Ut("Vehicle Invisibility")), (e) => Ce(this.vehicle.scriptID, !e, !1)),
      this.addItem((this.godmodeItem = new Ut("Vehicle Godmode")), (e) => C_.setInvincible(this.vehicle, e)),
      this.addItem((this.turbulenceItem = new Ut("Disable Plane Turbulence")), (e) => ze(this.vehicle.scriptID, e ? 0 : 1)),
      ...
      this.menuObject.MenuOpen.on(() => {
        h.local.vehicle ? this.vehicle != h.local.vehicle && (this.updateVehicle(h.local.vehicle), (this.invisibilityItem.Checked = !Ye(this.vehicle.scriptID)), (this.godmodeItem.Checked = !je(this.vehicle.scriptID)), (this.turbulenceItem.Checked = !1), M_.unlockMenuItems(this.menuObject)) : (this.updateVehicle(void 0), M_.lockMenuItems(this.menuObject), M_.unlockMenuItem(this.engineTorqueItem), M_.unlockMenuItem(this.torqueMultiplierItem));
      });
  }
  updateVehicle(e) {
    (this.vehicle = e), (this.vehicleCustomizationMenu.vehicle = e), (this.vehicleCustomizationMenu.vehicleColorMenu.vehicle = e), (this.vehicleCustomizationMenu.vehicleWheelsMenu.vehicle = e);
  }
}
!(function (e) {
  ...
  (function (e) {
    (e[(e.Adder = 3078201489)] = "Adder"),
      ...
      (e[(e.Conada = 3817135397)] = "Conada"),
      (e[(e.Corsita = 3540279623)] = "Corsita"),
      ...
      (e[(e.Draugur = 3526730918)] = "Draugur"),
      ...
      (e[(e.Greenwood = 40817712)] = "Greenwood"),
      ...
      (e[(e.Kanjosj = 4230891418)] = "Kanjosj"),
      ...
      (e[(e.Omnisegt = 3789743831)] = "Omnisegt"),
      ...
      (e[(e.Postlude = 4000288633)] = "Postlude"),
      ...
      (e[(e.Ruiner4 = 1706945532)] = "Ruiner4"),
      ...
      (e[(e.Rhinehart = 2439462158)] = "Rhinehart"),
      ...
      (e[(e.Sentine14 = 2938086457)] = "Sentinel4"),
      ...
      (e[(e.Toros = 4129572538)] = "Toros"),
      (e[(e.Torero2 = 3126015148)] = "Torero2"),
      ...
      (e[(e.Tenf = 3400983137)] = "Tenf"),
      (e[(e.Tenf2 = 274946574)] = "Tenf2"),
      ...
      (e[(e.Vigero2 = 2536587772)] = "Vigero2"),
      ...
      (e[(e.Weevil2 = 3300595976)] = "Weevil2"),
...
class E_ extends f_ {
  constructor(e, t) {
    super(e, t), (this.classMenus = []), this.addUserInputItem((this.customVehicleItem = new At("Spawn Custom Vehicle")), async () => C_.create(d(await t_.getUserInput()))), w_.getValues(m_).forEach((e) => this.classMenus.push(new v_(this, Ke("VEH_CLASS_" + e), +e))), w_.getValues(h_).forEach((e) => this.getVehicleClassMenu(Xe(+e)).addVehicle(+e)), this.classMenus.forEach((e) => M_.sortMenuItems(e.menuObject));
  }
...
!(function (e) {
  (e[(e.AMMO_PISTOL = 1950175060)] = "AMMO_PISTOL"),
    ...
    (e[(e.AMMO_GRENADELAUNCHER_SMOKE = 826266432)] = "AMMO_GRENADELAUNCHER_SMOKE"),
    ...
    (e[(e.AMMO_SNIPER_ARMORPIERCING = 2797387177)] = "AMMO_SNIPER_ARMORPIERCING"),
    ...
    (e[(e.AMMO_SHOTGUN_ARMORPIERCING = 1923327840)] = "AMMO_SHOTGUN_ARMORPIERCING"),
  ...
  (function (e) {
    (e[(e.Dagger = 2460120199)] = "Dagger"),
      ...
      (e[(e.ServiceCarbine = 3520460075)] = "ServiceCarbine");
      (e[(e.Metaldetector = 3684886537)] = "Metaldetector");
      (e[(e.PrecisionRifle = 1853742572)] = "PrecisionRifle");
...
class H_ {
  constructor() {
    (this.weapons = {}),
      (this.weapons[d_.Dagger] = { name: "wt_dagger", description: "wtd_dagger" }),
      (this.weapons[d_.Bat] = { name: "wt_bat", description: "wtd_bat" }),
      (this.weapons[d_.Bottle] = { name: "wt_bottle", description: "wtd_bottle" }),
      (this.weapons[d_.Crowbar] = { name: "wt_crowbar", description: "wtd_crowbar" }),
      (this.weapons[d_.Unarmed] = { name: "wt_unarmed" }),
      (this.weapons[d_.Flashlight] = { name: "wt_flashlight", description: "wtd_flashlight" }),
      (this.weapons[d_.GolfClub] = { name: "wt_golfclub", description: "wtd_golfclub" }),
      (this.weapons[d_.Hammer] = { name: "wt_hammer", description: "wtd_hammer" }),
      (this.weapons[d_.Hatchet] = { name: "wt_hatchet", description: "wtd_hatchet" }),
      (this.weapons[d_.KnuckleDusters] = { name: "wt_knuckle", description: "wtd_knuckle" }),
      (this.weapons[d_.Knife] = { name: "wt_knife", description: "wtd_knife" }),
      (this.weapons[d_.Machete] = { name: "wt_machete", description: "wtd_machete" }),
      (this.weapons[d_.Switchblade] = { name: "wt_swblade", description: "wtd_swblade" }),
      (this.weapons[d_.Nightstick] = { name: "wt_ngtstk", description: "wtd_ngtstk" }),
      (this.weapons[d_.PipeWrench] = { name: "wt_wrench", description: "wtd_wrench" }),
      (this.weapons[d_.BattleAxe] = { name: "wt_battleaxe", description: "wtd_battleaxe" }),
      (this.weapons[d_.PoolCue] = { name: "wt_poolcue", description: "wtd_poolcue" }),
      (this.weapons[d_.StoneHatchet] = { name: "wt_shatchet", description: "wtd_shatchet" }),
      (this.weapons[d_.Pistol] = { name: "wt_pist", description: "wt_pist_desc" }),
      (this.weapons[d_.PistolMk2] = { name: "wt_pist2", description: "wtd_pist2" }),
      (this.weapons[d_.CombatPistol] = { name: "wt_pist_cbt", description: "wtd_pist_cbt" }),
      (this.weapons[d_.APPistol] = { name: "wt_pist_ap", description: "wtd_pist_ap" }),
      (this.weapons[d_.StunGun] = { name: "wt_stun", description: "wtd_stun" }),
      (this.weapons[d_.Pistol50] = { name: "wt_pist_50", description: "wtd_pist_50" }),
      (this.weapons[d_.SNSPistol] = { name: "wt_snspistol", description: "wtd_snspistol" }),
      (this.weapons[d_.SNSPistolMk2] = { name: "wt_snspistol2", description: "wtd_snspistol2" }),
      (this.weapons[d_.HeavyPistol] = { name: "wt_hvypistol", description: "wtd_hvypistol" }),
      (this.weapons[d_.VintagePistol] = { name: "wt_vpistol", description: "wtd_vpistol" }),
      (this.weapons[d_.FlareGun] = { name: "wt_flaregun", description: "wtf_flaregun" }),
      (this.weapons[d_.MarksmanPistol] = { name: "wt_mkpistol", description: "wtd_mkpistol" }),
      (this.weapons[d_.HeavyRevolver] = { name: "wt_revolver", description: "wtd_revolver" }),
      (this.weapons[d_.HeavyRevolverMk2] = { name: "wt_revolver2", description: "wtd_revolver2" }),
      (this.weapons[d_.DoubleActionRevolver] = { name: "wt_rev_da", description: "wtd_rev_da" }),
      (this.weapons[d_.UpNAtomizer] = { name: "wt_raypistol", description: "wtd_raypistol" }),
      (this.weapons[d_.CeramicPistol] = { name: "wt_cerpst", description: "wtd_cerpst" }),
      (this.weapons[d_.NavyRevolver] = { name: "wt_rev_nv", description: "wtd_rev_nv" }),
      (this.weapons[d_.MicroSMG] = { name: "wt_smg_mcr", description: "wtd_smg_mcr" }),
      (this.weapons[d_.SMG] = { name: "wt_smg", description: "wtd_smg" }),
      (this.weapons[d_.SMGMk2] = { name: "wt_smg2", description: "wtd_smg2" }),
      (this.weapons[d_.AssaultSMG] = { name: "wt_smg_asl", description: "wtd_smg_asl" }),
      (this.weapons[d_.CombatPDW] = { name: "wt_combatpdw", description: "wtd_combatpdw" }),
      (this.weapons[d_.MachinePistol] = { name: "wt_mchpist", description: "wtd_mchpist" }),
      (this.weapons[d_.MiniSMG] = { name: "wt_minismg", description: "wtd_minismg" }),
      (this.weapons[d_.UnholyHellbringer] = { name: "wt_raycarbine", description: "wtd_raycarbine" }),
      (this.weapons[d_.PumpShotgun] = { name: "wt_sg_pmp", description: "wtd_sg_pmp" }),
      (this.weapons[d_.PumpShotgunMk2] = { name: "wt_sg_pmp2", description: "wtd_sg_pmp2" }),
      (this.weapons[d_.SawedOffShotgun] = { name: "wt_sg_sof", description: "wtd_sg_sof" }),
      (this.weapons[d_.AssaultShotgun] = { name: "wt_smg_asl", description: "wtd_smg_asl" }),
      (this.weapons[d_.BullpupShotgun] = { name: "wt_sg_blp", description: "wtd_sg_blp" }),
      (this.weapons[d_.Musket] = { name: "wt_musket", description: "wtd_musket" }),
      (this.weapons[d_.HeavyShotgun] = { name: "wt_hvyshgn", description: "wtd_hvyshgn" }),
      (this.weapons[d_.DoubleBarrelShotgun] = { name: "wt_dbshgn", description: "wtd_dbshgn" }),
      (this.weapons[d_.SweeperShotgun] = { name: "wt_autoshgn", description: "wtd_autoshgn" }),
      (this.weapons[d_.AssaultRifle] = { name: "wt_rifle_asl", description: "wtd_rifle_asl" }),
      (this.weapons[d_.AssaultRifleMk2] = { name: "wt_rifle_asl2", description: "wtd_rifle_asl2" }),
      (this.weapons[d_.CarbineRifle] = { name: "wt_rifle_cbn", description: "wtd_rifle_cbn" }),
      (this.weapons[d_.CarbineRifleMk2] = { name: "wt_rifle_cbn2", description: "wtd_rifle_cbn2" }),
      (this.weapons[d_.AdvancedRifle] = { name: "wt_rifle_adv", description: "wtd_rifle_adv" }),
      (this.weapons[d_.SpecialCarbine] = { name: "wt_spcarbine", description: "wtd_spcarbine" }),
      (this.weapons[d_.SpecialCarbineMk2] = { name: "wt_spcarbine2", description: "wtd_spcarbine2" }),
      (this.weapons[d_.BullpupRifle] = { name: "wt_bullrifle", description: "wtd_bullrifle" }),
      (this.weapons[d_.BullpupRifleMk2] = { name: "wt_bullrifle2", description: "wtd_bullrifle2" }),
      (this.weapons[d_.CompactRifle] = { name: "wt_cmprifle", description: "wtd_cmprifle" }),
      (this.weapons[d_.MG] = { name: "wt_mg", description: "wtd_mg" }),
      (this.weapons[d_.CombatMG] = { name: "wt_mg_cbt", description: "wtd_mg_cbt" }),
      (this.weapons[d_.CombatMGMk2] = { name: "wt_mg_cbt2", description: "wtd_mg_cbt2" }),
      (this.weapons[d_.Gusenberg] = { name: "wt_gusnbrg", description: "wtd_gusnbrg" }),
      (this.weapons[d_.SniperRifle] = { name: "wt_snip_rif", description: "wtd_snip_rif" }),
      (this.weapons[d_.HeavySniper] = { name: "wt_snip_hvy", description: "wtd_snip_hvy" }),
      (this.weapons[d_.HeavySniperMk2] = { name: "wt_snip_hvy2", description: "wtd_snip_hvy2" }),
      (this.weapons[d_.MarksmanRifle] = { name: "wt_mkrifle", description: "wtd_mkrifle" }),
      (this.weapons[d_.MarksmanRifleMk2] = { name: "wt_mkrifle2", description: "wtd_mkrifle2" }),
      (this.weapons[d_.RPG] = { name: "wt_rpg", description: "wtd_rpg" }),
      (this.weapons[d_.GrenadeLauncher] = { name: "wt_cmpgl", description: "wtd_cmpgl" }),
      (this.weapons[d_.TearGasLauncher] = { name: "wt_gl_smoke", description: "wtd_gl_smoke" }),
      (this.weapons[d_.Minigun] = { name: "wt_minigun", description: "wtd_minigun" }),
      (this.weapons[d_.FireworkLauncher] = { name: "wt_firewrk", description: "wtd_firewrk" }),
      (this.weapons[d_.Railgun] = { name: "wt_railgun", description: "wtd_railgun" }),
      (this.weapons[d_.HomingLauncher] = { name: "wt_homlnch", description: "wtd_homlnch" }),
      (this.weapons[d_.CompactGrenadeLauncher] = { name: "wt_cmpgl", description: "wtd_cmpgl" }),
      (this.weapons[d_.Widowmaker] = { name: "wt_rayminigun", description: "wtd_rayminigun" }),
      (this.weapons[d_.Grenade] = { name: "wt_gnade", description: "wtd_gnade" }),
      (this.weapons[d_.BZGas] = { name: "wt_bzgas", description: "wtd_bzgas" }),
      (this.weapons[d_.TearGas] = { name: "wt_gnade_smk", description: "wtd_gnade_smk" }),
      (this.weapons[d_.Flare] = { name: "wt_flare", description: "wtd_flare" }),
      (this.weapons[d_.Molotov] = { name: "wt_molotov", description: "wtd_molotov" }),
      (this.weapons[d_.StickyBomb] = { name: "wt_gnade_stk", description: "wtd_gnade_stk" }),
      (this.weapons[d_.ProximityMine] = { name: "wt_prxmine", description: "wtd_prxmine" }),
      (this.weapons[d_.Snowball] = { name: "wt_snwball", description: "wtd_snwball" }),
      (this.weapons[d_.PipeBomb] = { name: "wt_pipebomb", description: "wtd_pipebomb" }),
      (this.weapons[d_.Ball] = { name: "wt_ball", description: "wtd_ball" }),
      (this.weapons[d_.JerryCan] = { name: "wt_petrol", description: "wtd_petrol" }),
      (this.weapons[d_.FireExtinguisher] = { name: "wt_fire", description: "wtd_fire" }),
      (this.weapons[d_.HazardousJerryCan] = { name: "wt_hazardcan", description: "wtd_hazardcan" });
  }
}
class x_ {
  constructor() {
    (this.components = {}),
      ...
      (this.components[d_.UpNAtomizer] = [{ key: "component_raypistol_varmod_xmas18", name: "wct_var_ray18", description: "wcd_var_ray18" }]),
      ...
      (this.components[d_.MiniSMG] = [{ key: "component_minismg_clip_02", name: "wct_clip2", description: "wcd_mimg_clip2" }]),
      ...
      (this.components[d_.SawedOffShotgun] = [{ key: "component_sawnoffshotgun_varmod_luxe", name: "wct_var_metal" }]),
      ...
      (this.components[d_.Gusenberg] = [{ key: "component_gusenberg_clip_02", name: "wct_clip2", description: "wcd_gsnb_clip2" }]),
    ...
    super(e, t),
      ...
      this.menuObject.MenuOpen.on(() => {
        ...
        (this.weaponInfo.Text = Ke(t.name)),
          (this.weaponInfo.Description = "NULL" == _ ? "" : _.length > 140 ? _.substr(0, 139) + "..." : _),
          this.menuObject.MenuItems.splice(1),
          N_.componentCollection.components[e]?.forEach((t) => {
            let _ = new At(Ke(t.name), "NULL" == Ke(t.description) ? "" : Ke(t.description));
            this.addItem(_, async () => {
              let i = qe(h.local.scriptID, e, d(t.key));
              i ? await __.removeWeaponComponent(e, d(t.key)) : await __.addWeaponComponent(e, d(t.key)), this.toggleItem(_, i);
            });
          });
      });
  }
...
class B_ extends f_ {
  constructor(e, t) {
    super(e, t),
      ...
      this.addUserInputItem((this.giveWeaponItem = new At("Give Weapon")), async () => __.giveWeapon(d(await t_.getUserInput()), !0)),
      this.addUserInputItem((this.removeWeaponItem = new At("Remove Weapon")), async () => __.removeWeapon(d(await t_.getUserInput()))),
      this.addItem((this.giveAllWeaponsItem = new At("Give All Weapons")), () => w_.getValues(d_).forEach((e) => __.giveWeapon(+e))),
      this.addItem((this.refillAmmoItem = new At("Refill Ammo")), () => w_.getValues(p_).forEach((e) => $e(h.local.scriptID, +e, 250))),
      this.addItem((this.infiniteAmmoItem = new Ut("Infinite Ammo")), (e) => w_.getValues(d_).forEach((t) => Qe(h.local.scriptID, e, +t))),
      this.addItem((this.noReloadItem = new Ut("No Reload")), (e) => et(h.local.scriptID, e)),
      this.addItem((this.removeAllWeaponsItem = new At("Remove All Weapons")), () => __.removeAllWeapons()),
      (this.removeAllWeaponsItem.LeftBadge = mt.Alert);
  }
}
!(function (e) {
  (e.Altostratus = "altostratus"), (e.Cirrus = "Cirrus"), (e.Cirrocumulus = "cirrocumulus"), (e.Clear01 = "Clear 01"), (e.Cloudy01 = "Cloudy 01"), (e.Contrails = "Contrails"), (e.Horizon = "Horizon"), (e.HorizonBand1 = "horizonband1"), (e.HorizonBand2 = "horizonband2"), (e.HorizonBand3 = "horizonband3"), (e.Horsey = "horsey"), (e.Nimbus = "Nimbus"), (e.Puffs = "Puffs"), (e.Rain = "RAIN"), (e.Snowy01 = "Snowy 01"), (e.Stormy01 = "Stormy 01"), (e.Stratocumulus = "stratoscumulus"), (e.Stripey = "Stripey"), (e.Shower = "shower"), (e.Wispy = "Wispy");
})(u_ || (u_ = {})),
  (function (e) {
    (e[(e.AirRaceBoost01 = 0)] = "AirRaceBoost01"),
      ...
      (e[(e.hud_def_lensdistortion_subtle = 187)] = "hud_def_lensdistortion_subtle"),
      ...
      (e[(e.IMpExt_Interior_02_stair_cage = 192)] = "IMpExt_Interior_02_stair_cage"),
      ...
      (e[(e.LODmult_HD_orphan_LOD_reduce = 303)] = "LODmult_HD_orphan_LOD_reduce"),
      ...
      (e[(e.mp_battle_int01_dancefloor_OFF = 349)] = "mp_battle_int01_dancefloor_OFF"),
      ...
      (e[(e.MP_casino_apartment_barPARTY = 381)] = "MP_casino_apartment_barPARTY"),
      (e[(e.MP_casino_apartment_barPARTY_0 = 382)] = "MP_casino_apartment_barPARTY_0"),
      (e[(e.MP_casino_apartment_barPARTY_01 = 383)] = "MP_casino_apartment_barPARTY_01"),
      (e[(e.MP_casino_apartment_barPARTY_2 = 384)] = "MP_casino_apartment_barPARTY_2"),
      (e[(e.MP_casino_apartment_Bath = 385)] = "MP_casino_apartment_Bath"),
      (e[(e.MP_casino_apartment_changing = 386)] = "MP_casino_apartment_changing"),
      (e[(e.MP_casino_apartment_cinema = 387)] = "MP_casino_apartment_cinema"),
      (e[(e.MP_casino_apartment_colour0 = 388)] = "MP_casino_apartment_colour0"),
      (e[(e.MP_casino_apartment_colour1 = 389)] = "MP_casino_apartment_colour1"),
      (e[(e.MP_casino_apartment_colour2 = 390)] = "MP_casino_apartment_colour2"),
      ...
      (e[(e.MP_corona_heist_night_blend = 403)] = "MP_corona_heist_night_blend"),
      ...
      (e[(e.mp_x17dlc_facility_conference = 480)] = "mp_x17dlc_facility_conference"),
      (e[(e.mp_x17dlc_facility2 = 481)] = "mp_x17dlc_facility2"),
      (e[(e.mp_x17dlc_in_sub = 482)] = "mp_x17dlc_in_sub"),
      (e[(e.mp_x17dlc_in_sub_no_reflection = 483)] = "mp_x17dlc_in_sub_no_reflection"),
      ...
      (e[(e.mp_x17dlc_int_02_outdoor_intro_camera = 496)] = "mp_x17dlc_int_02_outdoor_intro_camera"),
      ...
      (e[(e.mp_x17dlc_int_02_vehicle_avenger_camera = 506)] = "mp_x17dlc_int_02_vehicle_avenger_camera"),
      (e[(e.mp_x17dlc_int_02_vehicle_workshop_camera = 507)] = "mp_x17dlc_int_02_vehicle_workshop_camera"),
      (e[(e.mp_x17dlc_int_02_weapon_avenger_camera = 508)] = "mp_x17dlc_int_02_weapon_avenger_camera"),
      ...
      (e[(e.player_transition_no_scanlines = 622)] = "player_transition_no_scanlines"),
      (e[(e.player_transition_scanlines = 623)] = "player_transition_scanlines"),
...
class F_ extends f_ {
  constructor(e, t) {
    super(e, t),
      ...
      this.addItem((this.gameClockItem = new Ht("Game Clock Hours", void 0, new vt([...Array(24).keys()]))), (e) => t_.setTime(e, 0, 0)),
      this.addItem((this.artificialLights = new Ut("Toggle Artificial Lights", !0)), (e) => t_.setArtificialLightsState(!e)),
      this.addItem((this.freezeTime = new Ut("Freeze Time")), (e) => {
        if (e) {
          let e = [tt(), _t(), it()];
          e_.register("world:freezeTime", () => t_.setTime(e[0], e[1], e[2]), 500), (this.freezeTime.Description = `Time frozen at ~y~${e[0]}:${e[1]}:${e[2]}`);
...
class G_ extends f_ {
  constructor(e, t) {
    super(e, t),
      ...
      this.menuObject.MenuOpen.on(() => M_.selectItem(this.menuObject.MenuItems[t_.getCurrentWeather()], mt.Tick));
  }
}
class W_ extends f_ {
  constructor(e, t) {
    super(e, t),
      this.addItem((this.opacityItem = new Ht("Opacity", void 0, new vt([...Array(11).keys()]))), (e) => t_.setCloudHatOpacity(e / 10)),
      w_.getStringKeys(u_).forEach((e) => this.addItem(new At(e.toUpperCase()))),
      this.menuObject.MenuOpen.on(() => {
...
class V_ extends f_ {
  constructor(e, t) {
    super(e, t), this.addUserInputItem((this.customItem = new At("Custom Timecycle")), async () => at(await t_.getUserInput())), this.addItem((this.clearItem = new At("Clear Timecycle")), () => st()), w_.getKeys(g_).forEach((e) => this.addItem(new At(e.toUpperCase()), () => at(e)));
  }
}
class z_ extends Kt {
  constructor(e, t) {
    super(e, t), (this.onlineMenu = new R_(this, "Online Options")), (this.playerMenu = new S_(this, "Player Options")), (this.vehicleMenu = new U_(this, "Vehicle Options")), (this.vehicleSpawnerMenu = new E_(this, "Vehicle Spawner")), (this.weaponMenu = new B_(this, "Weapon Options")), (this.WorldMenu = new F_(this, "World Options")), (this.miscMenu = new y_(this, "Misc Options"));
  }
}
const Y_ = new (class extends class {
  ...
  init() {
    ...
    f("keyup", (t) => {
      t == ot.M && (this.isAnyMenuOpen() || e.menuObject.Open());
    });
  }
})();
qt.init(), Y_.init();
